	...
	<div id="navbar-container" class="boxed">
		...
		<div class="navbar-header">
			<a href="index.html" class="navbar-brand">
				<img src="<?=base_url()?>template/img/logo.png" alt="Nifty Logo" class="brand-icon">
				<div class="brand-title">
					<span class="brand-text">Oklay</span> 
				</div>
			</a>
		</div>
									...
									<li>
										<a href="#" class="media">
											<div class="media-left">
												<img src="img/av2.png" alt="Profile Picture" class="<?=base_url()?>template/img-circle img-sm">
											</div>
				...
				<li id="dropdown-user" class="dropdown">
					<a href="#" data-toggle="dropdown" class="dropdown-toggle text-right">
						<span class="pull-right">
							<img class="img-circle img-user media-object" src="<?=base_url()?>user_pictures/<?=$this->session->imagen?>" alt="Profile Picture">
						</span>
						<div class="username "><span class="hidden-xs text-primary"><?=$this->session->tipo?> |</span> <?=$this->session->nombre?></div>
					</a>
