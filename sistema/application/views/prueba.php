...
<!-- Mirrored from www.themeon.net/nifty/v2.2.3/pages-blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Feb 2016 19:33:06 GMT -->
...
<head>
    ...
    <link href="<?=base_url()?>template/css/nifty.min.css" rel="stylesheet">

    
    <!--Font Awesome [ OPTIONAL ]-->
    <link href="<?=base_url()?>template/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet">


    <!--Switchery [ OPTIONAL ]-->
    <link href="<?=base_url()?>template/plugins/switchery/switchery.min.css" rel="stylesheet">


    <!--Bootstrap Select [ OPTIONAL ]-->
    <link href="<?=base_url()?>template/plugins/bootstrap-select/bootstrap-select.min.css" rel="stylesheet">


    <!--Demo [ DEMONSTRATION ]-->
    <link href="<?=base_url()?>template/css/demo/nifty-demo.min.css" rel="stylesheet">
...
<body>
    ...
    <script src="<?=base_url()?>template/js/nifty.min.js"></script>
    ...
    <link href="<?=base_url()?>template/plugins/pace/pace.min.css" rel="stylesheet">
    <script src="<?=base_url()?>template/plugins/pace/pace.min.js"></script>
...
<!-- Mirrored from www.themeon.net/nifty/v2.2.3/pages-blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 24 Feb 2016 19:33:39 GMT -->
</html>
